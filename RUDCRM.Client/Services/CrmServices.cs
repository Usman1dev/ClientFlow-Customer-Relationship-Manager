...
public class CustomerService
{
    ...
    {
        var r = await _http.DeleteAsync($"api/customers/{id}"); return r.IsSuccessStatusCode;
    }
}
...
public class WeatherService
{
    ...
    {
        try { return await _http.GetFromJsonAsync<WeatherDto>($"api/weather/{Uri.EscapeDataString(city)}"); }
        catch { return null; }
    }
}
