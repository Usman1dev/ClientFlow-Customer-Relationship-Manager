...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        builder.Services.AddScoped<RUDCRM.Server.Services.AuthService>();
        builder.Services.AddScoped<RUDCRM.Server.Services.CustomerService>();
        builder.Services.AddScoped<RUDCRM.Server.Services.LeadService>();
        builder.Services.AddScoped<RUDCRM.Server.Services.AppointmentService>();
        builder.Services.AddScoped<RUDCRM.Server.Services.InvoiceService>();
        builder.Services.AddScoped<RUDCRM.Server.Services.PaymentService>();
        builder.Services.AddScoped<RUDCRM.Server.Services.TaskService>();
        builder.Services.AddScoped<RUDCRM.Server.Services.NotificationService>();
        builder.Services.AddScoped<RUDCRM.Server.Services.FileUploadService>();
        builder.Services.AddScoped<RUDCRM.Server.Services.DashboardService>();
