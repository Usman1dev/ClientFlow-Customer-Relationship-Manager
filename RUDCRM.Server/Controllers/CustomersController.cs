...
<<<<<<< HEAD
        ...
        {
            return BadRequest("Cannot delete customer because they have existing invoices. Please delete or reassign the invoices first.");
        }

        // Manually delete other related entities to bypass SQL RESTRICT constraints
